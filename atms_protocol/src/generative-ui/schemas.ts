...
import {
  ATMS_A2UI_CATALOG_ID,
  ATMS_A2UI_MAX_COMPONENTS,
  ATMS_A2UI_MAX_DIRECT_CHILDREN,
  ATMS_A2UI_MAX_SOURCE_ITEMS,
  ATMS_A2UI_VERSION,
} from "./a2ui.js";
import { ATMS_VIEW_SPEC_VERSION } from "./view-spec.js";
...
export const atmsViewNodeSchema = {
  $id: "atms-view-node-v1",
  type: "object",
  properties: {
    id: identifier,
    ...
    children: { type: "array", minItems: 1, maxItems: 24, items: { $ref: "atms-view-node-v1" } },
    item: { $ref: "atms-view-node-v1" },
    ...
    title: { $ref: "atms-view-value-v1" },
    text: { $ref: "atms-view-value-v1" },
    label: { $ref: "atms-view-value-v1" },
    value: { $ref: "atms-view-value-v1" },
    unit: { $ref: "atms-view-value-v1" },
    uri: { $ref: "atms-view-value-v1" },
    description: { $ref: "atms-view-value-v1" },
    alt: { $ref: "atms-view-value-v1" },
...
export const atmsViewSpecSchema = {
  $id: "atms-view-spec-v1",
  type: "object",
  properties: {
    view_version: { const: ATMS_VIEW_SPEC_VERSION },
    root: { $ref: "atms-view-node-v1" },
  },
...
export const atmsA2uiDataBindingSchema = {
  $id: "atms-a2ui-data-binding-v1",
  type: "object",
...
const dynamicValueRef = { $ref: "atms-a2ui-dynamic-value-v1" } as const;
const dynamicStringRef = { $ref: "atms-a2ui-dynamic-string-v1" } as const;
const dynamicNumberRef = { $ref: "atms-a2ui-dynamic-number-v1" } as const;
const dynamicBooleanRef = { $ref: "atms-a2ui-dynamic-boolean-v1" } as const;
...
export const atmsA2uiFunctionCallSchema = {
  $id: "atms-a2ui-function-call-v1",
  oneOf: [
    ...
    functionVariant("and", {
      values: { type: "array", minItems: 2, maxItems: ATMS_A2UI_MAX_DIRECT_CHILDREN, items: dynamicBooleanRef },
    }, ["values"]),
    functionVariant("or", {
      values: { type: "array", minItems: 2, maxItems: ATMS_A2UI_MAX_DIRECT_CHILDREN, items: dynamicBooleanRef },
    }, ["values"]),
...
function catalogCompatibleSchema(value: unknown): unknown {
  ...
  return Object.fromEntries(Object.entries(record).map(([key, entry]) => {
    ...
    const commonType = {
      "atms-a2ui-data-binding-v1": "DataBinding",
      "atms-a2ui-dynamic-value-v1": "DynamicValue",
      "atms-a2ui-dynamic-string-v1": "DynamicString",
      "atms-a2ui-dynamic-number-v1": "DynamicNumber",
      "atms-a2ui-dynamic-boolean-v1": "DynamicBoolean",
      "atms-a2ui-child-list-v1": "ChildList",
      "atms-a2ui-action-v1": "Action",
    }[entry];
...
export const atmsA2uiCatalogFunctionSchemas = Object.fromEntries(
  atmsA2uiFunctionCallSchema.oneOf
...
export const atmsA2uiDynamicValueSchema = {
  $id: "atms-a2ui-dynamic-value-v1",
  oneOf: [
    { type: "string" },
    { type: "number" },
    { type: "boolean" },
    { type: "array" },
    { $ref: "atms-a2ui-data-binding-v1" },
    { $ref: "atms-a2ui-function-call-v1" },
  ],
} as const;

export const atmsA2uiDynamicStringSchema = {
  $id: "atms-a2ui-dynamic-string-v1",
  oneOf: [
    a2uiShortString,
    { $ref: "atms-a2ui-data-binding-v1" },
    { $ref: "atms-a2ui-function-call-v1" },
...
export const atmsA2uiDynamicNumberSchema = {
  $id: "atms-a2ui-dynamic-number-v1",
  oneOf: [
    { type: "number" },
    { $ref: "atms-a2ui-data-binding-v1" },
    { $ref: "atms-a2ui-function-call-v1" },
...
export const atmsA2uiDynamicBooleanSchema = {
  $id: "atms-a2ui-dynamic-boolean-v1",
  oneOf: [
    { type: "boolean" },
    { $ref: "atms-a2ui-data-binding-v1" },
    { $ref: "atms-a2ui-function-call-v1" },
...
export const atmsA2uiChildListSchema = {
  $id: "atms-a2ui-child-list-v1",
  oneOf: [
    {
      type: "array",
      maxItems: ATMS_A2UI_MAX_DIRECT_CHILDREN,
      items: identifier,
    },
    {
      type: "object",
...
export const atmsA2uiActionSchema = {
  $id: "atms-a2ui-action-v1",
  oneOf: [
    {
      type: "object",
      properties: {
    ...
    {
      type: "object",
      properties: { functionCall: { $ref: "atms-a2ui-function-call-v1" } },
...
const a2uiChildrenRef = { $ref: "atms-a2ui-child-list-v1" } as const;
const a2uiSourceRef = { $ref: "atms-a2ui-data-binding-v1" } as const;
const a2uiChecks = {
  type: "array",
  maxItems: ATMS_A2UI_MAX_DIRECT_CHILDREN,
...
const basicComponentSchemas = [
  ...
  componentSchema("Button", {
    ...
    action: { $ref: "atms-a2ui-action-v1" },
  ...
  componentSchema("ChoicePicker", {
    ...
    options: {
      type: "array",
      maxItems: ATMS_A2UI_MAX_SOURCE_ITEMS,
      items: {
        type: "object",
...
const maxItemsSchema = { type: "integer", minimum: 1, maximum: ATMS_A2UI_MAX_SOURCE_ITEMS } as const;
...
const atmsComponentSchemas = [
  ...
  componentSchema("HrTable", {
    ...sourceProperties,
    columns: { type: "array", minItems: 1, maxItems: ATMS_A2UI_MAX_DIRECT_CHILDREN, items: tableColumnSchema },
  }, ["source", "columns"]),
...
const componentDescriptions: Readonly<Record<string, string>> = {
  HrGrid: "Responsive one-to-three column layout for a compact Atms Block.",
  HrGridItem: "One child placed in a bounded span of a Atms grid.",
  ...
  HrStatusBadge: "A short status label using Atms semantic tones.",
  ...
  HrLink: "A labelled, credential-free HTTP(S) reference that opens outside Atms.",
  HrArtifact: "A passive preview reference to a Atms-published image, HTML page, or file.",
...
export const atmsA2uiCatalogComponentSchemas = Object.fromEntries(
  [...basicComponentSchemas, ...atmsComponentSchemas]
    .map((schema) => catalogComponentEntry(schema as Record<string, unknown>)),
) as Readonly<Record<string, Record<string, unknown>>>;

export const atmsA2uiComponentSchema = {
  $id: "atms-a2ui-component-v1",
  oneOf: [...basicComponentSchemas, ...atmsComponentSchemas],
} as const;

export const atmsA2uiSurfacePropertiesSchema = {
  $id: "atms-a2ui-surface-properties-v1",
  type: "object",
  properties: {
...
export const atmsA2uiCatalogDefinition = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: ATMS_A2UI_CATALOG_ID,
  title: "Atms A2UI Core Catalog",
  description: "A2UI v1.0 Basic components plus bounded Atms components for dense, responsive agent interfaces.",
  catalogId: ATMS_A2UI_CATALOG_ID,
  instructions: [
    "Use a flat A2UI component graph with exactly one root component.",
    "Prefer one coherent Block per user intent and use Atms components for metrics, status, progress, lists, tables, timelines, charts, DAGs, disclosures, safe source links, and published artifacts.",
    "Use only semantic tones and bounded grid spans; do not emit HTML, CSS, JavaScript, coordinates, or arbitrary style values.",
    "Action events must target host-registered Atms actions. The Atms host rejects local function actions, event context, response paths, and response requests.",
  ].join("\n\n"),
  $defs: {
    surfaceProperties: Object.fromEntries(Object.entries(atmsA2uiSurfacePropertiesSchema)
      .filter(([name]) => name !== "$id")),
    anyComponent: {
      oneOf: Object.keys(atmsA2uiCatalogComponentSchemas)
        .map((name) => ({ $ref: `#/components/${name}` })),
    },
    anyFunction: {
      oneOf: Object.keys(atmsA2uiCatalogFunctionSchemas)
        .map((name) => ({ $ref: `#/functions/${name}` })),
    },
  },
  components: atmsA2uiCatalogComponentSchemas,
  functions: atmsA2uiCatalogFunctionSchemas,
} as const;

export const atmsA2uiSurfaceSchema = {
  $id: "atms-a2ui-surface-v1",
  type: "object",
  properties: {
    version: { const: ATMS_A2UI_VERSION },
    catalogId: { const: ATMS_A2UI_CATALOG_ID },
    components: {
      type: "array",
      minItems: 1,
      maxItems: ATMS_A2UI_MAX_COMPONENTS,
      items: { $ref: "atms-a2ui-component-v1" },
    },
    surfaceProperties: { $ref: "atms-a2ui-surface-properties-v1" },
  },
  required: ["version", "catalogId", "components"],
  additionalProperties: false,
} as const;

export const atmsA2uiCreateSurfaceMessageSchema = {
  $id: "atms-a2ui-create-surface-message-v1",
  type: "object",
  properties: {
    version: { const: ATMS_A2UI_VERSION },
    createSurface: {
...
const nodeProperties = {
  ...
  view: { $ref: "atms-view-spec-v1" },
  a2ui: { $ref: "atms-a2ui-surface-v1" },
...
export const generativeUiSchemas: Record<string, Record<string, unknown>> = {
  "atms-view-value-v1": viewValueSchema as Record<string, unknown>,
  "atms-view-node-v1": atmsViewNodeSchema as Record<string, unknown>,
  "atms-view-spec-v1": atmsViewSpecSchema as Record<string, unknown>,
  "atms-a2ui-data-binding-v1": atmsA2uiDataBindingSchema as Record<string, unknown>,
  "atms-a2ui-function-call-v1": atmsA2uiFunctionCallSchema as Record<string, unknown>,
  "atms-a2ui-dynamic-value-v1": atmsA2uiDynamicValueSchema as Record<string, unknown>,
  "atms-a2ui-dynamic-string-v1": atmsA2uiDynamicStringSchema as Record<string, unknown>,
  "atms-a2ui-dynamic-number-v1": atmsA2uiDynamicNumberSchema as Record<string, unknown>,
  "atms-a2ui-dynamic-boolean-v1": atmsA2uiDynamicBooleanSchema as Record<string, unknown>,
  "atms-a2ui-child-list-v1": atmsA2uiChildListSchema as Record<string, unknown>,
  "atms-a2ui-action-v1": atmsA2uiActionSchema as Record<string, unknown>,
  "atms-a2ui-component-v1": atmsA2uiComponentSchema as Record<string, unknown>,
  "atms-a2ui-surface-properties-v1": atmsA2uiSurfacePropertiesSchema as Record<string, unknown>,
  "atms-a2ui-surface-v1": atmsA2uiSurfaceSchema as Record<string, unknown>,
  "atms-a2ui-create-surface-message-v1": atmsA2uiCreateSurfaceMessageSchema as Record<string, unknown>,
