...
import type { AtmsA2uiSurfaceV1 } from "./a2ui.js";
import type { AtmsViewSpecV1 } from "./view-spec.js";
...
export interface GenerativeUiPluginRef {
  /** Reverse-DNS plugin id, for example com.atms.core. */
  id: string;
  version: string;
}
...
> {
  ...
  id: string;
  /** Globally namespaced semantic kind, for example com.atms.core/task_summary. */
  kind: string;
