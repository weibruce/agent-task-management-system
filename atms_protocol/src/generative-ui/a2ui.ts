...
/** Exact upstream revision used to define the Atms A2UI v1.0 catalog. */
export const ATMS_A2UI_UPSTREAM_COMMIT = "16425ca82061f756e420d2453e066d0c7c0295c1" as const;
export const ATMS_A2UI_VERSION = "v1.0" as const;
export const ATMS_A2UI_CATALOG_ID = "https://atms.dev/a2ui/catalogs/core/v1" as const;
export const ATMS_A2UI_MAX_BYTES = 64 * 1024;
export const ATMS_A2UI_MAX_DEPTH = 8;
export const ATMS_A2UI_MAX_COMPONENTS = 128;
export const ATMS_A2UI_MAX_DIRECT_CHILDREN = 24;
export const ATMS_A2UI_MAX_SOURCE_ITEMS = 50;

export type A2uiVersionV1 = typeof ATMS_A2UI_VERSION;
...
/**
 * Deterministic functions exposed by the Atms profile. `openUrl` and
 ...
 */
export const ATMS_A2UI_PURE_FUNCTIONS = [
  "@index",
  "and",
  "email",
  "formatCurrency",
...
export type A2uiPureFunctionNameV1 = (typeof ATMS_A2UI_PURE_FUNCTIONS)[number];

/** Standard A2UI FunctionCall shape, restricted to Atms's pure catalog. */
...
export type AtmsA2uiGapV1 = "none" | "xs" | "sm" | "md" | "lg";
export type AtmsA2uiAlignV1 = "start" | "center" | "end" | "stretch";
export type AtmsA2uiToneNameV1 = "neutral" | "info" | "positive" | "warning" | "critical";
export type AtmsA2uiToneV1 = AtmsA2uiToneNameV1 | A2uiDataBindingV1 | A2uiFunctionCallV1;
export type AtmsA2uiFormatV1 = "text" | "number" | "percent" | "datetime" | "duration" | "status" | "tone";

export interface AtmsA2uiGridComponentV1 extends A2uiComponentCommonV1 {
  component: "HrGrid";
  children: A2uiChildListV1;
  columns: { default: 1 | 2 | 3; compact: 1 | 2 | 3 };
  gap?: AtmsA2uiGapV1;
  align?: AtmsA2uiAlignV1;
}

export interface AtmsA2uiGridItemComponentV1 extends A2uiComponentCommonV1 {
  component: "HrGridItem";
  child: string;
  span: 1 | 2 | 3;
}

export interface AtmsA2uiSectionComponentV1 extends A2uiComponentCommonV1 {
  component: "HrSection";
...
export interface AtmsA2uiMetricComponentV1 extends A2uiComponentCommonV1 {
  component: "HrMetric";
  label: A2uiDynamicStringV1;
...
export interface AtmsA2uiStatusBadgeComponentV1 extends A2uiComponentCommonV1 {
  component: "HrStatusBadge";
  text: A2uiDynamicStringV1;
  tone?: AtmsA2uiToneV1;
}

export interface AtmsA2uiProgressComponentV1 extends A2uiComponentCommonV1 {
...
export interface AtmsA2uiStepComponentV1 extends A2uiComponentCommonV1 {
  component: "HrStep";
...
interface AtmsA2uiSourceComponentV1 extends A2uiComponentCommonV1 {
  source: A2uiDataBindingV1;
  maxItems?: number;
}

export interface AtmsA2uiListComponentV1 extends AtmsA2uiSourceComponentV1 {
  component: "HrList";
...
export interface AtmsA2uiTimelineComponentV1 extends AtmsA2uiSourceComponentV1 {
...
export interface AtmsA2uiBarChartComponentV1 extends AtmsA2uiSourceComponentV1 {
...
export interface AtmsA2uiDagComponentV1 extends AtmsA2uiSourceComponentV1 {
  component: "HrDag";
  itemIdPath: string;
  itemLabelPath: string;
  itemDetailPath?: string;
...
export interface AtmsA2uiTableComponentV1 extends AtmsA2uiSourceComponentV1 {
  component: "HrTable";
  columns: Array<{
    id: string;
    label: string;
    path: string;
    format?: AtmsA2uiFormatV1;
  }>;
}

export interface AtmsA2uiDisclosureComponentV1 extends A2uiComponentCommonV1 {
...
export interface AtmsA2uiLinkComponentV1 extends A2uiComponentCommonV1 {
  component: "HrLink";
  label: A2uiDynamicStringV1;
  url: A2uiDynamicStringV1;
  description?: A2uiDynamicStringV1;
...
export interface AtmsA2uiArtifactComponentV1 extends A2uiComponentCommonV1 {
...
export interface AtmsA2uiIfComponentV1 extends A2uiComponentCommonV1 {
  component: "HrIf";
  condition: A2uiDynamicBooleanV1;
  children: A2uiChildListV1;
}
...
export type AtmsA2uiCatalogComponentV1 =
  | AtmsA2uiGridComponentV1
  | AtmsA2uiGridItemComponentV1
  | AtmsA2uiSectionComponentV1
  | AtmsA2uiMetricComponentV1
  | AtmsA2uiStatusBadgeComponentV1
  | AtmsA2uiProgressComponentV1
  | AtmsA2uiStepComponentV1
  | AtmsA2uiListComponentV1
  | AtmsA2uiTableComponentV1
  | AtmsA2uiTimelineComponentV1
  | AtmsA2uiBarChartComponentV1
  | AtmsA2uiDagComponentV1
  | AtmsA2uiDisclosureComponentV1
  | AtmsA2uiLinkComponentV1
  | AtmsA2uiArtifactComponentV1
  | AtmsA2uiIfComponentV1;

export type A2uiComponentV1 = A2uiBasicComponentV1 | AtmsA2uiCatalogComponentV1;

export interface AtmsA2uiSurfacePropertiesV1 {
  iconUrl?: string;
  agentDisplayName?: string;
}

export interface AtmsA2uiSurfaceV1 {
  version: A2uiVersionV1;
  catalogId: typeof ATMS_A2UI_CATALOG_ID;
  components: A2uiComponentV1[];
  surfaceProperties?: AtmsA2uiSurfacePropertiesV1;
}

/** Exact standard v1.0 createSurface envelope, before Atms narrows it. */
...
/** Standard A2UI v1.0 createSurface message specialized to a direct Atms surface. */
export interface AtmsA2uiCreateSurfaceMessageV1 extends A2uiCreateSurfaceMessageV1 {
  createSurface: {
    surfaceId: string;
    catalogId: typeof ATMS_A2UI_CATALOG_ID;
    surfaceProperties?: AtmsA2uiSurfacePropertiesV1;
...
export interface AtmsA2uiSemanticIssueV1 {
  path: string;
  message: string;
  keyword: string;
}

export interface AtmsA2uiSemanticOptionsV1 {
...
const PURE_FUNCTIONS = new Set<string>(ATMS_A2UI_PURE_FUNCTIONS);
...
/**
 * Performs Atms semantic checks that JSON Schema cannot express: graph
 * integrity, materialization budgets, binding scope, Actions and URI safety.
 */
export function analyzeAtmsA2uiSurfaceSemantics(
  surface: AtmsA2uiSurfaceV1,
  options: AtmsA2uiSemanticOptionsV1 = {},
): AtmsA2uiSemanticIssueV1[] {
  const prefix = options.path ?? "";
  const issues: AtmsA2uiSemanticIssueV1[] = [];
  ...
  if (surface.catalogId !== ATMS_A2UI_CATALOG_ID) {
    issue("/catalogId", `catalogId must be ${ATMS_A2UI_CATALOG_ID}`, "a2uiCatalogId");
  }
  if (surface.components.length > ATMS_A2UI_MAX_COMPONENTS) {
    issue(
      "/components",
      `declared component count exceeds ${ATMS_A2UI_MAX_COMPONENTS}`,
  ...
  for (const [id, entry] of components) {
    ...
    if (directChildren > ATMS_A2UI_MAX_DIRECT_CHILDREN) {
      issue(
        `/components/${entry.index}`,
        `direct child count exceeds ${ATMS_A2UI_MAX_DIRECT_CHILDREN}`,
  ...
  const checkDepth = (id: string, depth: number, ancestors: ReadonlySet<string>): void => {
    ...
    if (depth > ATMS_A2UI_MAX_DEPTH) {
      const index = components.get(id)?.index ?? 0;
      issue(
        `/components/${index}`,
        `component depth exceeds ${ATMS_A2UI_MAX_DEPTH}`,
        "maxA2uiDepth",
      );
      return;
    }
  ...
  const validateDynamic = (
    ...
    if (isFunctionCall(value)) {
      if (!PURE_FUNCTIONS.has(value.call)) {
        issue(`${path}/call`, `function is not in the pure Atms catalog: ${value.call}`, "a2uiPureFunction");
      }
  ...
  const validateAction = (action: A2uiActionV1, index: number, scope: EvaluationScope): void => {
    ...
    if (Object.prototype.hasOwnProperty.call(action.event, "responsePath")) {
      issue(
        ...
        "responsePath is not supported by the Atms host",
        "a2uiResponsePath",
      );
    ...
    if (Object.keys(action.event.context ?? {}).length > 0) {
      issue(
        `${path}/event/context`,
        "non-empty event.context is not supported by the Atms host",
        "a2uiActionContext",
      );
    }
  ...
  if (!hasStructuralGraphError && components.has("root")) {
    ...
    const count = (amount: number, path: string): boolean => {
      materialized += amount;
      if (materialized <= ATMS_A2UI_MAX_COMPONENTS) return true;
      if (!materializedExceeded) {
        materializedExceeded = true;
        issue(
          path,
          `materialized component count exceeds ${ATMS_A2UI_MAX_COMPONENTS}`,
    ...
    const sourceItems = (sourcePath: string, path: string, scope: EvaluationScope): unknown[] | undefined => {
      ...
      if (source.length > ATMS_A2UI_MAX_SOURCE_ITEMS) {
        issue(
          path,
          `source exceeds ${ATMS_A2UI_MAX_SOURCE_ITEMS} items`,
          "maxA2uiSourceItems",
        );
      }
      return source.slice(0, ATMS_A2UI_MAX_SOURCE_ITEMS);
    };
    ...
    const materialize = (id: string, scope: EvaluationScope): void => {
      ...
      if (SOURCE_COMPONENTS.has(component.component) && "source" in component) {
        ...
        if (items) count(Math.min(items.length, component.maxItems ?? ATMS_A2UI_MAX_SOURCE_ITEMS), base);
      }
      for (const edge of adjacency.get(id) ?? []) {
        ...
        if (edge.template) {
          ...
          if (items === undefined) {
            ...
            if (items.length > ATMS_A2UI_MAX_DIRECT_CHILDREN) {
              issue(
                base,
                `materialized direct child count exceeds ${ATMS_A2UI_MAX_DIRECT_CHILDREN}`,
                "maxA2uiDirectChildren",
              );
            }
 ...
 */
export function createAtmsA2uiCreateSurfaceMessage(input: {
  id: string;
  content: Record<string, unknown>;
  a2ui: AtmsA2uiSurfaceV1;
}): AtmsA2uiCreateSurfaceMessageV1 {
  return {
    version: ATMS_A2UI_VERSION,
    createSurface: {
      surfaceId: input.id,
