...
export const ATMS_MANAGER_TURN_PUBLIC_KEY_ENV = "ATMS_MANAGER_TURN_PUBLIC_KEY";
export const ATMS_MANAGER_TURN_KEY_ID_ENV = "ATMS_MANAGER_TURN_KEY_ID";
export const ATMS_MANAGER_TURN_ENVELOPE_REQUIRED_ENV = "ATMS_MANAGER_TURN_ENVELOPE_REQUIRED";
export const ATMS_MANAGER_TURN_HEADER = "x-atms-manager-turn";
...
export function validateManagerAgentTurnEnvelope(
  ...
  if (claims.issuer !== "atms-manager") errors.push({ path: "/claims/issuer", message: "invalid issuer" });
  if (claims.audience !== "atms-manager-agent-worker") errors.push({ path: "/claims/audience", message: "invalid audience" });
