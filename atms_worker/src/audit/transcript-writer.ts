/**
 * Transcript writer — appends JSONL to ATMS_HOME/audit/transcripts/{run-id}.jsonl.
 * @version 0.1.0
 */
...
import { redactTelemetry } from "atms-protocol";
...
export function createTranscriptWriter(
  ...
  const dir = baseDir ?? atmsPath("audit", "transcripts");
