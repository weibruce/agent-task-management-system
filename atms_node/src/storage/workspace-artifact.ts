...
import { atmsHomePath, atmsWorkerWorkspacePath } from "./atms-home.js";
...
export async function createWorkspaceArtifactArchive(
  ...
  const workspaceRoot = atmsWorkerWorkspacePath(request.workspace_id);
  ...
  const stagingDir = atmsHomePath("node", "artifact-staging");
