...
- the successful outcome remains a Draft PR marked `ready_for_ci` in Atms,
...
- `atms_manager/src/orchestration/workflow-spec-v1-schema.ts`
- `atms_manager/src/orchestration/workflow-spec-v1.ts`
- `atms_manager/src/runtime/active-runs.ts`
...
- [ ] Make `atms templates list` report strict v1 static nodes and bounded dynamic
      worker capacity accurately.
- [ ] Ensure `atms dag quick`, chats, handoffs, scorecard, eval-run, and replay
...
[`xiaotianfotos/atms#172`](https://github.com/xiaotianfotos/atms/issues/172).
