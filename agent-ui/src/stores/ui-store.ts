...
export const useUiStore = defineStore('ui', () => {
  ...
  const appearanceId = ref<string>(DEFAULT_APPEARANCE_ID)
  ...
  function setAppearance(_newAppearanceId: string) {
    // Appearance is fixed to the default cockpit theme.
    appearanceId.value = DEFAULT_APPEARANCE_ID
