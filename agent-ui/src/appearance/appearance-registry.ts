...
export const APPEARANCE_TOKEN_NAMES = [
  ...
  '--atms-focus-ring',
  '--atms-selection',
  '--atms-scrollbar-track',
  '--atms-scrollbar',
  '--atms-scrollbar-hover',
  '--atms-ambient-accent',
  '--atms-ambient-info',
  '--atms-canvas-ambient-primary',
  '--atms-canvas-ambient-secondary',
  '--atms-decorative-accent-soft',
  '--atms-decorative-accent-border',
  '--atms-decorative-speaking-soft',
  '--atms-decorative-speaking-border',
  '--atms-settings-sidebar',
  '--atms-settings-card',
  '--atms-settings-card-hover',
  '--atms-settings-divider',
  '--atms-settings-active',
  '--atms-settings-active-border',
  '--atms-radius-lg',
  '--atms-radius-md',
  '--atms-radius-sm',
  '--atms-shadow-panel',
  '--atms-shadow-floating',
  '--atms-shadow-accent',
] as const
...
export interface AppearancePlugin {
   ...
   * scoped to `:root[data-atms-appearance='<id>']`; components only consume the
   * token contract and never branch on the plugin id.
   */
  tokens?: AppearanceTokens
}

export const APPEARANCE_STORAGE_KEY = 'atms.appearance'
export const APPEARANCE_COLOR_SCHEME_STORAGE_KEY = 'atms.appearance-color-scheme'
export const LEGACY_SKIN_STORAGE_KEY = 'atms.skin'
export const LEGACY_THEME_STORAGE_KEY = 'omni_theme'
export const DEFAULT_APPEARANCE_ID = 'cockpit'
export const ARTIFACT_APPEARANCE_MESSAGE_TYPE = 'atms:artifact-appearance'
...
export function artifactAppearanceMessage(doc: Document = document): ArtifactAppearanceMessage {
  const appearance = getAppearancePlugin(doc.documentElement.dataset.atmsAppearance)
...
function broadcastArtifactAppearance(doc: Document): void {
  for (const frame of doc.querySelectorAll<HTMLIFrameElement>('iframe[data-atms-artifact-frame]')) {
...
export function applyAppearanceToDocument(
  ...
  root.dataset.atmsAppearance = plugin.id
