...
export interface AtmsBuiltinRendererComponentV1 {
  component: Component
  mode: GenerativeUiRendererMode
}

const catalog = new Map<string, AtmsBuiltinRendererComponentV1>([
  ['core-legacy-widget', {
...
export function resolveAtmsBuiltinRendererComponent(
  rendererId: string,
): AtmsBuiltinRendererComponentV1 | undefined {
