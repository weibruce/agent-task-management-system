...
import type { GenerativeUiCompositionItemV1, GenerativeUiStoredNodeV1 } from 'atms-protocol'
...
function placement(variant: GenerativeUiCompositionItemV1['variant']): GenerativeUiCompositionItemV1 {
  return {
    node_id: 'com.atms.pr-closeout:pr-21',
    node_revision: 1,
    surface: 'result',
    variant,
    rank: 1,
...
describe('PrCloseoutRenderer', () => {
  ...
  it('renders a dense evidence dashboard and a real dependency graph', () => {
    ...
    const mounted = mount({
      ...
      repository: 'xiaotianfotos/atms',
      pr_number: 21,
      pr_url: 'https://github.com/xiaotianfotos/atms/pull/21',
      status: 'draft',
      recommendation: 'blocked',
      risk: 'medium',
