...
function descriptor(input: Partial<AtmsUiWidgetDescriptor> = {}): AtmsUiWidgetDescriptor {
  return {
...
describe('Atms UI widget registry', () => {
  it('lists bounded stable identities and operates through host callbacks', () => {
    const registry = new AtmsUiWidgetRegistry()
