...
describe('A2UI evaluator', () => {
  it('implements every protocol-allowed pure function', () => {
    ...
    expect(new Set(ATMS_A2UI_PURE_FUNCTIONS)).toEqual(testedCalls)
    ...
    expect(call('email', { value: 'dev@atms.test' })).toBe(true)
    ...
    expect(call('length', { value: 'Atms', min: 4, max: 10 })).toBe(true)
