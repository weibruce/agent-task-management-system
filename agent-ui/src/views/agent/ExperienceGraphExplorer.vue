...
function nodeAccent(type: string): string {
  ...
  return tone === 'text2' ? 'var(--atms-text-2)' : `var(--atms-${tone})`
}
    ...
    <div class="experience-shell">
      <header class="experience-topbar">
        <div class="experience-topbar__left">
          ...
          <div class="experience-brand">Atms</div>
...
.experience-graph__ambient {
  ...
  pointer-events: none;
  background:
    radial-gradient(circle at 18% 12%, var(--atms-accent-soft), transparent 32%),
    radial-gradient(circle at 80% 2%, var(--atms-success-soft), transparent 30%),
    linear-gradient(180deg, transparent, var(--atms-surface-1));
}
...
.experience-topbar__metrics span {
  border: 1px solid var(--atms-info-border);
  border-radius: 9999px;
  background: var(--atms-info-soft);
  padding: 6px 10px;
  color: var(--atms-info);
  font-size: 12px;
  font-weight: 650;
...
.experience-panel--filters {
  border-color: var(--atms-decorative-accent-border);
  background:
    radial-gradient(circle at 86% 0%, var(--atms-decorative-accent-soft), transparent 34%),
    var(--atms-panel);
}

.experience-panel--details {
  border-color: var(--atms-decorative-speaking-border);
  background:
    radial-gradient(circle at 86% 0%, var(--atms-decorative-speaking-soft), transparent 34%),
    var(--atms-panel);
}
...
.experience-primary-button:hover:not(:disabled) {
  ...
  background: var(--atms-control-hover);
}
...
.experience-type-chip:hover {
  border-color: var(--atms-border-strong);
...
.experience-stage {
  position: relative;
  background:
    linear-gradient(var(--atms-border) 1px, transparent 1px),
    linear-gradient(90deg, var(--atms-border) 1px, transparent 1px),
    radial-gradient(circle at 50% 30%, var(--atms-decorative-accent-soft), transparent 34%),
    var(--atms-surface-1);
...
.experience-toast--error {
  border: 1px solid var(--atms-danger-border);
  background: var(--atms-danger-soft);
  color: var(--atms-danger);
}

.experience-toast--warning {
  border: 1px solid var(--atms-warning-border);
