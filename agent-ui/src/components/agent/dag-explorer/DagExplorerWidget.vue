...
.dag-explorer__node-mini {
  ...
  margin-top: 2px;
  color: var(--atms-text-3);
  font-family: var(--atms-font-mono, ui-monospace, monospace);
  font-size: 10px;
}
