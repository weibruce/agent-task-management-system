...
const dockerWorkspaceMessage = computed(() => {
  ...
  return dockerWorkspaceHostPath.value
    ...
    : t('onboarding.environmentCheck.dockerShareAtms')
})
      ...
      <div class="onboarding-wizard" role="dialog" aria-modal="true">
        ...
        <section v-else class="onboarding-wizard__body">
          ...
          <div v-if="hostShellRequired" class="onboarding-wizard__docker-check">
            <Terminal :class="cn('h-5 w-5', hostShellReady ? 'text-[var(--atms-success)]' : 'text-[var(--atms-accent)]')" />
          ...
          <div class="onboarding-wizard__docker-check">
            <FolderCheck :class="cn('h-5 w-5', dockerWorkspaceReady ? 'text-[var(--atms-success)]' : 'text-[var(--atms-accent)]')" />
            <div class="onboarding-wizard__docker-check-copy">
...
.onboarding-wizard__tab-dot {
  ...
  background: var(--atms-warning);
  box-shadow: 0 0 0 3px var(--atms-warning-soft);
}
...
.onboarding-wizard__step--active .onboarding-wizard__step-index {
  background: color-mix(in srgb, var(--atms-accent) 20%, transparent);
  color: var(--atms-text-1);
}
...
.onboarding-wizard__existing-agent {
  ...
  border-radius: 0.6rem;
  border: 1px solid color-mix(in srgb, var(--atms-accent) 18%, transparent);
  background: var(--atms-accent-soft);
  color: var(--atms-text-1);
  text-align: left;
}
...
.onboarding-wizard__existing-agent:not(:disabled):hover {
  border-color: var(--atms-accent-border);
  background: color-mix(in srgb, var(--atms-accent) 16%, transparent);
}
...
.onboarding-wizard__docker-check {
  ...
  border: 1px solid color-mix(in srgb, var(--atms-accent) 18%, transparent);
  background: color-mix(in srgb, var(--atms-accent) 5%, transparent);
}
...
.onboarding-wizard__docker-check-button:not(:disabled):hover {
  border-color: color-mix(in srgb, var(--atms-accent) 45%, transparent);
  background: var(--atms-accent-soft);
}
...
.onboarding-wizard__ready {
  ...
  border-radius: 0.7rem;
  border: 1px solid var(--atms-success-border);
  background: var(--atms-success-soft);
}
...
.onboarding-wizard__primary:not(.onboarding-wizard__primary--disabled):hover {
  background: color-mix(in srgb, var(--atms-accent) 24%, transparent);
