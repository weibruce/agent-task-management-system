...
.slide-deck-widget__thumb--active {
  border-color: var(--atms-accent-border) !important;
...
.slide-deck-widget__canvas {
  ...
  overflow: hidden;
  background:
    linear-gradient(135deg, var(--atms-surface-2), var(--atms-panel)),
    repeating-linear-gradient(90deg, var(--atms-border) 0 1px, transparent 1px 28px);
}
