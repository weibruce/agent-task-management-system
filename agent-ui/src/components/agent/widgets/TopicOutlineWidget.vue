...
import { isSafeGenerativeUiArtifactUri } from 'atms-protocol'
...
.topic-outline-widget__outline-pane {
  ...
  scrollbar-color: var(--atms-scrollbar) transparent;
...
.topic-outline-widget__outline-pane::-webkit-scrollbar-thumb:hover {
  background: var(--atms-scrollbar-hover);
}
