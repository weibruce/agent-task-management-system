...
const originalToken = process.env.ATMS_MANAGER_ADMIN_TOKEN;

afterEach(() => {
  if (originalToken === undefined) delete process.env.ATMS_MANAGER_ADMIN_TOKEN;
  else process.env.ATMS_MANAGER_ADMIN_TOKEN = originalToken;
});
