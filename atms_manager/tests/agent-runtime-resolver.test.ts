...
describe("agent runtime resolver", () => {
  ...
  beforeEach(() => {
    ...
    tmpHome = fs.mkdtempSync(path.join(os.tmpdir(), "atms-agent-runtime-resolver-"));
  ...
  it("runs a Atms Responses setting through Codex without treating it as an account model", () => {
    upsertProvider({
      id: "local-responses",
