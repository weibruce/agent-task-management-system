...
import {
  ATMS_WORKER_PROTOCOL_LABEL,
  ATMS_WORKER_SOURCE_LABEL,
  ATMS_WORKER_VERSION_LABEL,
...
function statusPath(): string {
  const dir = fs.mkdtempSync(path.join(os.tmpdir(), "atms-dag-environment-"));
  tempDirs.push(dir);
...
function currentWorkerVersion(): string {
  const packageJson = JSON.parse(
    fs.readFileSync(
      path.join(currentRepoRoot(), "atms_worker", "package.json"),
      "utf8",
    ),
  ) as { version: string };
...
function fingerprintFixture(): string {
  const repoRoot = fs.mkdtempSync(path.join(os.tmpdir(), "atms-worker-fingerprint-"));
  tempDirs.push(repoRoot);
  const files: Record<string, string> = {
    "atms_worker/Dockerfile": "FROM node:22\n",
    "atms_worker/native/codex-secret-guard.c": "int atms_guard(void) { return 0; }\n",
    "atms_worker/scripts/configure-apt-sources.mjs": "export const configureAptSources = true;\n",
    "atms_worker/package.json": JSON.stringify({
      name: "atms-worker",
      version: "0.1.0-alpha.1",
      dependencies: { "atms-protocol": "file:../atms_protocol" },
    }),
    "atms_worker/package-lock.json": JSON.stringify({
      name: "atms-worker",
      version: "0.1.0-alpha.1",
      lockfileVersion: 3,
      packages: {
        "": { name: "atms-worker", version: "0.1.0-alpha.1" },
        "../atms_protocol": { name: "atms-protocol", version: "0.1.0-alpha.1" },
      },
    }),
    "atms_worker/tsconfig.json": JSON.stringify({ compilerOptions: { strict: true } }),
    "atms_worker/dsh/atms.cordis.yml": "name: atms-dsh-test\n",
    "atms_worker/src/index.ts": "export const worker = true;\n",
    "atms_protocol/package.json": JSON.stringify({
      name: "atms-protocol",
      version: "0.1.0-alpha.1",
    }),
    "atms_protocol/package-lock.json": JSON.stringify({
      name: "atms-protocol",
      version: "0.1.0-alpha.1",
      lockfileVersion: 3,
      packages: {
        "": { name: "atms-protocol", version: "0.1.0-alpha.1" },
      },
    }),
    "atms_protocol/tsconfig.json": JSON.stringify({ compilerOptions: { strict: true } }),
    "atms_protocol/src/index.ts": "export const contract = 1;\n",
    "atms_plugin_sdk/package.json": JSON.stringify({
      name: "atms-plugin-sdk",
      version: "0.1.0-alpha.1",
      dependencies: { "atms-protocol": "file:../atms_protocol" },
    }),
    "atms_plugin_sdk/package-lock.json": JSON.stringify({
      name: "atms-plugin-sdk",
      version: "0.1.0-alpha.1",
      lockfileVersion: 3,
      packages: {
        "": { name: "atms-plugin-sdk", version: "0.1.0-alpha.1" },
        "../atms_protocol": { name: "atms-protocol", version: "0.1.0-alpha.1" },
      },
    }),
    "atms_manager/package.json": JSON.stringify({
      name: "atms-manager",
      version: "0.1.0-alpha.1",
      dependencies: {
        "atms-plugin-sdk": "file:../atms_plugin_sdk",
        "atms-protocol": "file:../atms_protocol",
      },
    }),
    "atms_manager/package-lock.json": JSON.stringify({
      name: "atms-manager",
      version: "0.1.0-alpha.1",
      lockfileVersion: 3,
      packages: {
        "": { name: "atms-manager", version: "0.1.0-alpha.1" },
        "../atms_plugin_sdk": { name: "atms-plugin-sdk", version: "0.1.0-alpha.1" },
        "../atms_protocol": { name: "atms-protocol", version: "0.1.0-alpha.1" },
      },
    }),
    "atms_node/package.json": JSON.stringify({
      name: "atms-node",
      version: "0.1.0-alpha.1",
      dependencies: { "atms-protocol": "file:../atms_protocol" },
    }),
    "atms_node/package-lock.json": JSON.stringify({
      name: "atms-node",
      version: "0.1.0-alpha.1",
      lockfileVersion: 3,
      packages: {
        "": { name: "atms-node", version: "0.1.0-alpha.1" },
        "../atms_protocol": { name: "atms-protocol", version: "0.1.0-alpha.1" },
      },
    }),
    "atms_cli/package.json": JSON.stringify({
      name: "atms-cli",
      version: "0.1.0-alpha.1",
      dependencies: {
        "atms-plugin-sdk": "file:../atms_plugin_sdk",
    ...
    "atms_cli/package-lock.json": JSON.stringify({
      name: "atms-cli",
      version: "0.1.0-alpha.1",
      lockfileVersion: 3,
      packages: {
        "": { name: "atms-cli", version: "0.1.0-alpha.1" },
        "../atms_plugin_sdk": { name: "atms-plugin-sdk", version: "0.1.0-alpha.1" },
        "../atms_protocol": { name: "atms-protocol", version: "0.1.0-alpha.1" },
      },
    }),
    ...
    "agent-ui/package-lock.json": JSON.stringify({
      ...
      lockfileVersion: 3,
      packages: {
        "": { name: "atms-agent-ui", version: "0.1.0-alpha.1" },
        "../atms_protocol": { name: "atms-protocol", version: "0.1.0-alpha.1" },
      },
    }),
  };
...
function imageInspection(
  ...
  return {
    stdout: JSON.stringify([{
      ...
      Config: {
        Labels: {
          [ATMS_WORKER_SOURCE_LABEL]: fingerprint,
          [ATMS_WORKER_PROTOCOL_LABEL]: protocol,
          [ATMS_WORKER_VERSION_LABEL]: workerVersion,
        },
      },
    }]),
    stderr: "",
...
it("ignores release-only package metadata in the Worker source fingerprint", () => {
  ...
  for (const relativePath of [
    "atms_worker/package.json",
    "atms_worker/package-lock.json",
    "atms_protocol/package.json",
    "atms_protocol/package-lock.json",
    "atms_plugin_sdk/package.json",
    "atms_plugin_sdk/package-lock.json",
    "atms_manager/package.json",
    "atms_manager/package-lock.json",
    "atms_node/package.json",
    "atms_node/package-lock.json",
    "atms_cli/package.json",
    "atms_cli/package-lock.json",
    ...
    if (metadata.packages?.["../atms_protocol"]) {
      metadata.packages["../atms_protocol"].version = "0.1.0-beta.99";
    }
    if (metadata.packages?.["../atms_plugin_sdk"]) {
      metadata.packages["../atms_plugin_sdk"].version = "0.1.0-beta.99";
    }
...
it("changes the Worker source fingerprint when build-relevant content changes", () => {
  ...
  const original = dagWorkerSourceFingerprint(repoRoot);
  fs.appendFileSync(
    path.join(repoRoot, "atms_worker", "src", "index.ts"),
...
it("changes the Worker source fingerprint when the DSH composition changes", () => {
  ...
  const original = dagWorkerSourceFingerprint(repoRoot);
  fs.appendFileSync(
    path.join(repoRoot, "atms_worker", "dsh", "atms.cordis.yml"),
    "changed: true\n",
  );
...
it("changes the Worker source fingerprint when the native secret guard changes", () => {
  ...
  const original = dagWorkerSourceFingerprint(repoRoot);
  fs.appendFileSync(
    path.join(repoRoot, "atms_worker", "native", "codex-secret-guard.c"),
    "int atms_guard_changed(void) { return 1; }\n",
  );
...
it("changes the Worker source fingerprint when build dependencies change", () => {
  const repoRoot = fingerprintFixture();
  const original = dagWorkerSourceFingerprint(repoRoot);
  const packagePath = path.join(repoRoot, "atms_worker", "package.json");
...
it("changes the Worker source fingerprint when projected Node dependencies change", () => {
  const repoRoot = fingerprintFixture();
  const original = dagWorkerSourceFingerprint(repoRoot);
  const packagePath = path.join(repoRoot, "atms_node", "package.json");
  const metadata = JSON.parse(fs.readFileSync(packagePath, "utf8")) as {
    dependencies: Record<string, string>;
  };
...
it("probes Docker from a stable temporary cwd when Worker source is absent", async () => {
  ...
  const controller = new DagEnvironmentController({
    commandRunner: runner,
    repoRoot: path.join(os.tmpdir(), "missing-atms-worker-source"),
    statusPath: statusPath(),
  });
...
it("keeps Docker ready when info is unavailable but version reports a Linux daemon", async () => {
  ...
  const runner: DagEnvironmentCommandRunner = vi.fn(async (_command, args) => {
    ...
    if (args[1] === "ls") {
      return {
        stdout: JSON.stringify({ Repository: "atms-worker", Tag: "latest", Labels: "" }),
        stderr: "",
      };
    }
...
it("lists only Atms images and marks the selected image current", async () => {
  const fingerprint = dagWorkerSourceFingerprint(currentRepoRoot());
  ...
  const runner: DagEnvironmentCommandRunner = vi.fn(async (_command, args) => {
    ...
    if (args[1] === "ls") {
      return {
        stdout: [
          JSON.stringify({ Repository: "atms-worker", Tag: "latest", Labels: `${ATMS_WORKER_SOURCE_LABEL}=${fingerprint}` }),
          JSON.stringify({ Repository: "postgres", Tag: "16", Labels: "" }),
          JSON.stringify({ Repository: "unrelated", Tag: "latest", Labels: "org.atms.worker.example=true" }),
          JSON.stringify({ Repository: "versioned-unrelated", Tag: "latest", Labels: `${ATMS_WORKER_VERSION_LABEL}=1.2.3` }),
        ].join("\n"),
        stderr: "",
      };
    }
...
it("reports image and connected Worker compatibility independently", async () => {
  ...
  const runner: DagEnvironmentCommandRunner = vi.fn(async (_command, args) => {
    ...
    if (args[0] === "info") return dockerInfo();
    if (args[1] === "ls") {
      return { stdout: JSON.stringify({ Repository: "atms-worker", Tag: "latest", Labels: "" }), stderr: "" };
    }
...
it("queues one asynchronous build, streams output, and probes the resulting image", async () => {
  ...
  expect(spawnImpl.mock.calls[0]?.[1]).toEqual(expect.arrayContaining([
    ...
    "--build-arg", `ATMS_WORKER_VERSION=${currentWorkerVersion()}`,
  ]));
...
it("persists a failed build and accepts a later retry that reaches ready", async () => {
  ...
  const runner: DagEnvironmentCommandRunner = vi.fn(async (_command, args) => {
    ...
    if (args[1] === "ls") {
      return {
        stdout: built
          ? JSON.stringify({ Repository: "atms-worker", Tag: "latest", Labels: "" })
          : "",
        stderr: "",
      };
    }
...
it("forwards validated build-network sources and proxy names to the Docker build", async () => {
  ...
  const controller = new DagEnvironmentController({
    ...
    statusPath: persistedPath,
    env: {
      ATMS_WORKER_BUILD_APT_MIRROR: "https://mirrors.example.com/debian/",
      ATMS_WORKER_BUILD_NPM_REGISTRY: "https://registry.example.com",
  ...
  expect(args).toEqual(expect.arrayContaining([
    "--build-arg", "ATMS_WORKER_BUILD_APT_MIRROR=https://mirrors.example.com/debian",
    "--build-arg", "NPM_CONFIG_REGISTRY=https://registry.example.com",
    "--build-arg", "ATMS_DSH_FORK_REPOSITORY=https://git.example.com/deepseek-harness.git",
...
it("reports invalid build-network configuration before a build is requested", () => {
  ...
  const controller = new DagEnvironmentController({
    ...
    statusPath: statusPath(),
    env: {
      ATMS_WORKER_BUILD_APT_MIRROR: "https://user:secret@mirrors.example.com/debian",
    },
  });
  ...
  expect(status.worker_image.message).toContain("ATMS_WORKER_BUILD_APT_MIRROR");
  expect(status.worker_image.error).toContain("ATMS_WORKER_BUILD_APT_MIRROR");
...
it("fails the build before Docker starts when build-network configuration is invalid", async () => {
  ...
  await vi.waitFor(() => expect(controller.getStatus().build?.status).toBe("failed"));
  const status = controller.getStatus();
  expect(status.build?.error).toContain("ATMS_WORKER_BUILD_APT_MIRROR");
...
it("normalizes persisted worker_image status that predates build_network", () => {
  ...
  const recovered = new DagEnvironmentController({
    repoRoot: currentRepoRoot(),
    statusPath: persistedPath,
    env: { ATMS_WORKER_BUILD_NPM_REGISTRY: "https://registry.example.com" },
  }).getStatus();
