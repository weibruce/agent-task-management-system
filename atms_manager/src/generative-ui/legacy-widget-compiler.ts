...
const CORE_OWNER: GenerativeUiPluginRef = { id: "com.atms.core", version: "0.1.8" };
const CONTENT_OWNER: GenerativeUiPluginRef = { id: "com.atms.content", version: "0.1.0" };
const PRESENTATION_OWNER: GenerativeUiPluginRef = { id: "com.atms.presentation", version: "0.1.0" };
const LEGACY_OWNER: GenerativeUiPluginRef = { id: "com.atms.legacy", version: "0.1.0" };
...
const KNOWN_MAPPINGS: Record<string, Omit<LegacyKindMapping, "preferred_visual">> = {
  ...
  progress: {
    owner: CORE_OWNER,
    kind: "com.atms.core/execution_progress",
  ...
  dag_flow: {
    owner: CORE_OWNER,
    kind: "com.atms.core/execution_graph",
    surface: GenerativeUiSurface.EXECUTION,
    density: GenerativeUiDensity.DETAIL,
  },
  timeline: {
    owner: CORE_OWNER,
    kind: "com.atms.core/timeline",
    surface: GenerativeUiSurface.EXECUTION,
    density: GenerativeUiDensity.SUMMARY,
  },
  metric_strip: {
    owner: CORE_OWNER,
    kind: "com.atms.core/metric_set",
    surface: GenerativeUiSurface.AMBIENT,
    density: GenerativeUiDensity.GLANCE,
  },
  chart: {
  ...
  confirmation: {
    owner: CORE_OWNER,
    kind: "com.atms.core/confirmation",
    surface: GenerativeUiSurface.TASK,
    density: GenerativeUiDensity.SUMMARY,
  },
  // Explicit M0 compatibility kind. New topic outlines use the independent
  // com.atms.topic-outline plugin and semantic execution side channel.
  topic_outline: {
    owner: CONTENT_OWNER,
