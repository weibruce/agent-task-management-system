...
const LEGACY_SHADOW_KINDS = new Set([
  "com.atms.core/task_summary",
  "com.atms.core/notice",
  "com.atms.core/checklist",
  "com.atms.core/execution_progress",
  "com.atms.core/execution_graph",
  "com.atms.core/timeline",
  "com.atms.core/metric_set",
  "com.atms.core/artifact",
  "com.atms.core/confirmation",
  "com.atms.content/topic_outline",
  "com.atms.content/xiaohongshu_note",
  "com.atms.presentation/slide_deck",
  "com.atms.legacy/rich_content",
  "com.atms.legacy/widget",
]);
