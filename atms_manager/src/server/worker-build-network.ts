export const WORKER_BUILD_APT_MIRROR_ENV_KEY = "ATMS_WORKER_BUILD_APT_MIRROR";
export const WORKER_BUILD_APT_SECURITY_MIRROR_ENV_KEY = "ATMS_WORKER_BUILD_APT_SECURITY_MIRROR";
export const WORKER_BUILD_NPM_REGISTRY_ENV_KEY = "ATMS_WORKER_BUILD_NPM_REGISTRY";
export const WORKER_BUILD_DSH_GIT_REMOTE_ENV_KEY = "ATMS_WORKER_BUILD_DSH_GIT_REMOTE";

export const WORKER_BUILD_APT_MIRROR_BUILD_ARG = "ATMS_WORKER_BUILD_APT_MIRROR";
export const WORKER_BUILD_APT_SECURITY_MIRROR_BUILD_ARG = "ATMS_WORKER_BUILD_APT_SECURITY_MIRROR";
export const WORKER_BUILD_NPM_REGISTRY_BUILD_ARG = "NPM_CONFIG_REGISTRY";
export const WORKER_BUILD_DSH_GIT_REMOTE_BUILD_ARG = "ATMS_DSH_FORK_REPOSITORY";
...
export function workerBuildNetworkDockerArgs(config: WorkerBuildNetworkConfig): string[] {
  ...
  // environment; Atms never places proxy values in argv.
