...
name: atms-pr-review
description: |
  Run Atms's built-in read-only pull request review DAG. Use when the user
...
atms dag artifact <run-id> pr-review.json --output pr-review.json
atms dag artifact <run-id> pr-review.md --output pr-review.md
```
